...
<p>   This requirement leads to determining the maximum of the so-called Rayleigh coefficient &lambda; = d' C<sub>2</sub> d/ (d' C<sub>1</sub> d). It is obtained as largest eigenvalue of the generalized eigenvalue problem |C<sub>2</sub> -&lambda; C<sub>1</sub>| =0.</p>
